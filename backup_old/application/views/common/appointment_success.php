				...
				<div class="col-sm-10 col-sm-offset-1 col-xs-12">
					<div class="th-404content">
						<div class="th-404tital th-no-margin">
							<h2><?php echo $status ? "<i class='fa fa-check'></i>" : "<i class='fa fa-times'></i>"?></h2>
						</div>
						<?php if($status) { ?>
						...
						<div class="th-description">
							<p>We were not able to book your appointment due to some technical issue occurred. Please retry filling the appointment form with relavant information. Sorry for the inconvinience. :( </p>
						</div>
						<?php } ?>
